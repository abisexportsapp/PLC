...
class SAPColors {
  SAPColors._();
  static const Color globalBlackColor =
      Colors.black; // for globaly used black color in any UI Component
  static const Color globalWhiteColor =
      Colors.white; // for globaly used white color in any UI Component
  static const Color cancelButtonColor =
      Color.fromARGB(255, 233, 235, 238); // for cancel button
  static const Color componentbackGroundColor =
      Color(0xffFFFFFF); // for any UI Component background color
  static const Color primaryButtonColor =
      Color(0xff0070F2); // for Primary Button Color
  static const Color secondaryButtonColor =
      Color.fromARGB(255, 237, 244, 255); // for Secondary Button Color
  static const Color darkThemeSecondaryButtonColor =
      Color.fromARGB(255, 42, 48, 53); // for Secondary Button Color
  static const Color snackbarBackgroundColor =
      Color(0xff12171C); // for Snackbar Background
  static const Color primaryButtonTextColor =
      Colors.black; // for primary button text Color
  static const Color secondaryButtonTextColor =
      Colors.blueAccent; // for secondary button text Color
  static const Color focusedTextColor =
      Colors.blueAccent; // for focused Textfield
  static const Color darkThemePrimaryColor =
      Color(0xff4DB1FF); // for Selected background
  static const Color bodybackGroundColor = Color.fromARGB(
      255, 249, 253, 255); // background color other then UI Component
...
ThemeData sapLightThemeColors = ThemeData(
  ...
  primaryColor: SAPColors.primaryButtonColor,
  scaffoldBackgroundColor: SAPColors.secondaryButtonColor,
  pageTransitionsTheme: const PageTransitionsTheme(builders: {
    TargetPlatform.android: CupertinoPageTransitionsBuilder(),
  }),
  bottomSheetTheme: const BottomSheetThemeData(
    // backgroundColor: Colors.white, --> optional if you want to change the background color
    surfaceTintColor: SAPColors.globalWhiteColor,
  ),
);

ThemeData sapDarkThemeColors = ThemeData(
  scaffoldBackgroundColor: SAPColors.globalBlackColor,
  primaryColor: SAPColors.globalBlackColor,
...
class SAPTheme extends ThemeExtension<SAPTheme> {
  ...
  Color cardButtonBackgroundColor;
  Color cardButtonBorderColor;
  Color cardButtonTextColor;

  SAPTheme(
      {required this.cardButtonBackgroundColor,
      required this.cardButtonBorderColor,
      required this.cardButtonTextColor,
...
SAPTheme sAPLightTheme = SAPTheme(
  cardButtonBackgroundColor: SAPColors.secondaryButtonColor,
  cardButtonBorderColor: SAPColors.primaryButtonColor,
  cardButtonTextColor: SAPColors.primaryButtonColor,
...
SAPTheme sAPDarkTheme = SAPTheme(
    cardButtonBackgroundColor: SAPColors.darkThemeBlackColor,
    cardButtonBorderColor: SAPColors.darkThemePrimaryColor,
    cardButtonTextColor: SAPColors.darkThemePrimaryColor,
    ...
    sliderDeactiveColor: SAPColors.darkThemeSecondaryButtonColor,
    slideractiveColor: SAPColors.darkThemePrimaryColor,
    sliderThumbColor: SAPColors.darkThemeSecondaryButtonColor,
    ...
    secondaryButtonBackgroundColor: SAPColors.darkThemeSecondaryButtonColor,
    ...
    listTileIconBackgroundColor: SAPColors.darkThemeSecondaryButtonColor,
    listTileIconColor: SAPColors.darkThemePrimaryColor,
    globalTextColor: SAPColors.globalWhiteColor);
SAPTheme sAPIBTheme = SAPTheme(
    cardButtonBackgroundColor: SAPColors.secondaryButtonColor,
    cardButtonBorderColor: Colors.green.shade600,
    cardButtonTextColor: Colors.green.shade600,
    appBarBackgroundColor: SAPColors.globalWhiteColor,
    snackbarTextColor: SAPColors.globalWhiteColor,
    snackbarBackgroundColor: SAPColors.snackbarBackgroundColor,
